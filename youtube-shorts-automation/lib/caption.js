...
Style: Default, Arial,${font_size},&H000000FF,&H00FFFFFF,&H64000000,&H32000000,-1,0,0,0,100,100,0,0,1,1.5,1,5,10,10,20,1
...
function formatTime(seconds, delay) {
    ...
    const s = Math.floor((seconds % 60) + delay).toFixed(2).padStart(5, '0');
